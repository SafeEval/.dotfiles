...
autocmd FileType sh autocmd FileWritePre    * :call TrimWhiteSpace()
autocmd FileType sh autocmd FileAppendPre   * :call TrimWhiteSpace()
autocmd FileType sh autocmd FilterWritePre  * :call TrimWhiteSpace()
autocmd FileType sh autocmd BufWritePre     * :call TrimWhiteSpace()
