...
autocmd FileType jsx autocmd FileWritePre    * :call TrimWhiteSpace()
autocmd FileType jsx autocmd FileAppendPre   * :call TrimWhiteSpace()
autocmd FileType jsx autocmd FilterWritePre  * :call TrimWhiteSpace()
autocmd FileType jsx autocmd BufWritePre     * :call TrimWhiteSpace()
